...
export default class AppIntroSlider extends React.Component {
 ...
 _renderDefaultButton = (name) => {
    let content = (name === 'Skip')? <Text style={{color:"#84432d",fontSize: 18, padding: 16,flexDirection:"row"}}>{this.props[`${name.toLowerCase()}Label`]}</Text>:<Text style={{color:"black",fontSize: 18, padding: 16,flexDirection:"row"}}>{this.props[`${name.toLowerCase()}Label`]}</Text>;
...
//change here 
 ...
 />
 {this._renderPagination()}
 <View style={{height:2,backgroundColor:"grey",opacity:0.7}}/>
