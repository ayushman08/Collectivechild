...
//       //  alert( JSON.stringify(this.props.appIntroReducer.checkprefRes.data.savedScreen))
...
Actions.contact();
 ...
 checkUpdatedScreen(){
  ...
  componentDidUpdate(){
    // alert(this.props.notFromSplash)
    console.log("Response>>>>"+JSON.stringify(this.props.appIntroReducer.checkprefRes));
   if(this.props.notFromSplash){
    // Actions.appIntro({type:'reset'})
   } else if(this.props.appIntroReducer.checkprefRes!=''&&  !this.props.notFromSplash){
       this.setState({isLoaded:false})
      //  this.setState({isSpinnerVisible:false})
       if(this.props.appIntroReducer.checkprefRes.status==="success"){

        //  alert(this.props.appIntroReducer.checkprefRes.data.savedScreen)
       //  console.log("Response+++++++++++++++ SCreen++++++"+JSON.stringify(this.props.appIntroReducer.checkprefRes.data.savedScreen))
         if(this.props.appIntroReducer.checkprefRes.data.savedScreen == STRINGS.SCREEN_ONE){Actions.contact({type:'reset'})  }
        else if(this.props.appIntroReducer.checkprefRes.data.savedScreen == STRINGS.SCREEN_TWO){Actions.servicePreferences({type:'reset'})  }
        else if(this.props.appIntroReducer.checkprefRes.data.savedScreen == STRINGS.SCREEN_THREE){Actions.pregnancyselection({type:'reset'})  }
      ...
      else  if(this.props.appIntroReducer.checkprefRes.data.savedScreen == STRINGS.SCREEN_ELEVEN){Actions.billingContactInformation({type:'reset'})  }
