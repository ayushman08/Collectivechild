...
class BillingContactInformation extends Component {
    ...
    //  alert(this.state.userInfo.billing_address)
      ...
      this.onCityChanged(this.state.userInfo.billing_city)
      this.onStateChanged(this.state.userInfo.billing_state)
      this.onZipcodeChanged(this.state.userInfo.billing_zipcode)
      this.onphoneNumberChanged(this.state.userInfo.contact_no)
         ...
         if(this.props.billingInfoReducer.billingRes!=''){
           ...
           if(this.props.billingInfoReducer.billingRes.status==="success"){
            ...
            if(this.state.checked){
               ...
               Actions.updatebillingcontactInformation({type:"reset"})
